...
/**
 * Representação de uma Disciplina de um aluno matriculado na UFCG, do curso de
 * Ciência da Computação.
 * 
 * Toda disciplina possui um nome, uma quantidade de horas associadas e várias
 * notas.
 * 
...
public class Disciplina {
	...
	/**
	 * O atributo horasDeEstudo refere-se a quantidade de horas destinadas aos
	 * estudo de determinada disciplina.
	 */
	...
	/**
	 * O array pesos faz referência a um conjuntos de pesos para as respectivas
	 * notas.
	 */
	private int[] pesos;
	 ...
	 * 
	 * @param nomeDisciplina : O nome da disciplina representado como uma cadeia de
	 *                       caracteres.
	 */
	 ...
	 * @param nomeDisciplina : O nome da disciplina representado como uma cadeia de
	 *                       caracteres.
	 * @param num            : O número de notas que o diário de disciplina terá,
	...
	/**
	 * Constrói uma Disciplina a partir do seu nome, número de notas e array de
	 * pesos, onde a partir do número de notas será criado um array de num notas de
	 * mesmo tamanho do array pesos.
	 * 
	 ...
	 * 
	 * @param horas : representa o número de horas que foram estudadas até o
	 *              momento. no formato de um número inteiro.
	 */
	...
	/**
	 * Não possui retorno, apenas adiciona uma nota a uma posição do diário da
	 * Disciplina.
	 * 
	...
	/**
	 * Retorna um double que representa a média da Disciplina. Calcula a média sem o
	 * array de pesos ou com.
	 * 
	...
	/**
	 * Retorna um boolean, true para o caso de o aluno ser aprovado (média maior ou
	 * igual a 7.0) ou false, (caso contrário).
	 * 
	 ...
	 * formato: NOME_DISCIPLINA HORAS_DE_ESTUDO MEDIA_GERAL [DIARIO DE NOTAS].
	 * 

 ...
 * 
 * Todo aluno possui um conjunto de disciplinas, contas de cantina, contas de
 * laboratório e uma saúde.
 * 
...
public class Aluno {
	...
	/**
	 * Constrói um aluno que possui disciplinas, contas de cantina e contas de
	 * laboratório.
	 */
	public Aluno() {
	...
	/**
	 * Cadastra um novo laboratório com uma cota informada pelo usuário. (valor
	 * inteiro).
	 * 
	 * @param nomeLaboratorio : nome do novo laboratório que será inserido na Lista.
	...
	/**
	 * Consome certa quantidade de memória do espaço disponível na conta. Espera-se
	 * um valor menor que. o limite disponível.
	 * 
	...
	/**
	 * Libera certa quantidade de memória do espaço disponível na conta. Espera-se
	 * um valor menor ou igual ao que está sendo utilizado no momento.
	 * 
	 * @param nomeLaboratorio : nome do laboratório que será modificado.
	 ...
	 * @param nomeLaboratorio : nome do laboratório que será modificado.
	 * 
	 * @return : retorna se a conta teve ou não seu limite atingido através de um
	 *         boolean (true/false).
	 */
	 ...
	 * @param pesos          : array de pesos para cada uma das notas do diário.
	 *                       OBS: assume-se que o número de pesos é igual ao número
	 *                       de notas.
	 */
	 ...
	 * 
	 * @param nomeDisciplina : nome da disciplina a ser alterada.
	 * @param nota           : posição do array a ser inserida a nota, assume-se que
	 *                       a nota estará numa posição válida do array.
	 ...
	 * 
	 * @return : (true/false) indicando se o aluno foi aprovado ou reprovado,
	 *         respectivamente.
	 */
	...
	/**
	 * Paga a conta de um aluno na Cantina, assume-se que o valor será menor ou
	 * igual que o débito.
	 * 
	 * @param nomeCantina   : o nome da cantina.
	 ...
	 * 
	 * @param valor : String "boa" ou "fraca" que representa o estado atual do
	 *              aluno.
	 */
